...
<body>
	...
	<main>
		...
		<button class="button" type="button"
			onclick="location.href='http://localhost:8080/ShoppingSite/jsp/servant_top.jsp'">戻る</button>
